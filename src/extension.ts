...
export function activate(context: vscode.ExtensionContext) {
	...
	vscode.window.createTreeView('Trello', {
		treeDataProvider: new Trello()
	});
	vscode.commands.registerCommand('Trello.refreshEntry', () =>
		trello.refresh()
	);

	vscode.commands.registerCommand('Trello.authenticate', () =>
		trello.authenticate()
	);
